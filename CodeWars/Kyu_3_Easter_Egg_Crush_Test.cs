...
Do you see that skyscraper? 
And can you tell me a maximal floor that if you drop your egg from will not crack it?
No, - said Eulampy.
But if you give me N eggs, - says Tempter - I'l tell you an answer.
Deal - said Eulampy. 
But I have one requirement before we start this: 
...
if they're thrown from a certain floor or below, they won't crack. Otherwise they crack.
You have n eggs and m tries
What is the maxmimum height, such that you can always determine which 
floor the target floor is when the target floor can be any floor between 1 to this maximum height?
Examples
height 0 14 = 0
height 2 0  = 0
height 2 14 = 105
...
namespace CodeWars
{
    class Kyu_3_Easter_Egg_Crush_Test
    {
        public static BigInteger Height(int n, int m)
        {
            BigInteger height = 0, fibCoef = 1;
            for (int i = 1; i < n + 1; i++)
            {
                fibCoef = fibCoef * m / i;
                height += fibCoef;
